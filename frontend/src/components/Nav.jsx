...
const Nav = () => {
    ...
    return (
        <nav className="h-[5rem] w-full flex justify-between "  style={{background:"#10BBB3"}}>
            ...
            <div className="flex mt-2 lg:mr-16 p-2 ">
                <div className="hidden lg:block md:block">
                    <div className="flex ">
                        <a href="/manager" className="flex gap-1 text-white hover:text-[#0c7773fc]  lg:text-xl md:text-sm  rounded-md px-3 py-2 text-sm font-small">
                            <IoSettingsOutline className='mt-1'/>
                            <span>Account Setting</span>
                        </a>
                        <a href="/writemessage" className="flex gap-1 text-white hover:text-[#0c7773fc] lg:text-xl md:text-sm rounded-md px-3 py-2 text-sm font-small" aria-current="page">
                            <BiSolidMessageSquare className='mt-1' />
                            <span> My Messages</span>
                        </a>
                        <a href="/cantact" className="flex gap-1 text-white hover:text-[#0c7773fc] lg:text-xl md:text-sm   rounded-md px-3 py-2 text-sm font-small">
                            <IoCall className='mt-1' />
                            <span> Contact Us</span>
                        </a>

                        <a href="/" className="flex gap-1 text-white hover:text-[#0c7773fc] lg:text-xl md:text-sm   rounded-md px-3 py-2 text-sm font-small">
